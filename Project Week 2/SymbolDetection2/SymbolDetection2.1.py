...
picam2 = Picamera2()
config = picam2.create_video_configuration(main={"size": (320, 240)}) # Keeping original resolution for ML compatibility
    ...
    for cnt in contours:
        ...
        if cv2.contourArea(cnt) > 1000:
            ...
            if M["m00"] != 0:
                ...
                # --- VISUAL DEBUGGING (Drawing on the frame) ---
