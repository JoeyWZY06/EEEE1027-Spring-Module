...
def detect_arrows(frame, hsv):
    color_ranges = {
        ...
        "Orange": [(9, 80, 80), (25, 255, 255)]
    }
    red_lower1, red_upper1 = np.array([0, 70, 70]), np.array([10, 255, 255])
    red_lower2, red_upper2 = np.array([160, 70, 70]), np.array([180, 255, 255])
...
def pause_robot(symbol_class):
    ...
    # 2. If the detected symbol name has "arrow" in it, turn on CV analysis flag
